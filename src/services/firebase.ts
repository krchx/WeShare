...
import { getDatabase, ref, set, onValue, onChildAdded, onDisconnect, remove, get, onChildRemoved } from 'firebase/database';
...
export class FirebaseService {
   ...
   */
  static registerPeerInRoom(roomId: string, userId: string, peerData: PeerData): void {
   ...
   */
  static onPeerJoined(roomId: string, callback: (peerId: string, userId: string) => void): () => void {
 ...
 */
static listenForDisconnections(roomId: string, callback: (userId: string) => void) {
